...
import com.example.lesson26.interfaes.AddNotificationFragmentListener
...
class AddNotificationFragment : Fragment() {
    ...
    private var addNotificationFragmentListener: AddNotificationFragmentListener? = null
    ...
    override fun onAttach(context: Context) {
        ...
        addNotificationFragmentListener = context as? AddNotificationFragmentListener
    ...
    private fun addNotification() {
        ...
        val notificationText = bindingAddNotificationFragment?.editTextNotification?.text?.toString()
